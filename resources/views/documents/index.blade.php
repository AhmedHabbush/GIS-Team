<x-layout>
    <x-slot:title>المستندات</x-slot:title>
            ...
            <table class="w-full border-collapse">
                ...
                @forelse($documents as $document)
                    <tr class="border-t">
                        ...
                        <td class="">
                            <div class="flex gap-2">
                                ...
                                @if(auth()->user()->hasPermission('documents.print'))
                                    <a
                                        href="{{ route('documents.print', $document) }}"
                                        target="_blank"
                    ...
                    <tr
                        ...
                        x-cloak
                    >
                        <td colspan="5" class="bg-gray-50 p-5">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">

                                {{-- معلومات أساسية --}}
                                <div class="space-y-2">
                                    <div class="flex gap-2">
                                        <span class="font-semibold text-gray-700 w-24">النوع:</span>
                        ...
                        {{ implode('، ', $document->types ?? []) ?: '—' }}
                                    ...
                                    <div class="flex gap-2">
                                        <span class="font-semibold text-gray-700 w-24">المربع:</span>
                                        <span class="text-gray-600">{{ $document->square ?? '—' }}</span>
                                    </div>

                                    <div class="flex gap-2">
                                        <span class="font-semibold text-gray-700 w-24">المخيم:</span>
                                        <span class="text-gray-600">{{ $document->camp ?? '—' }}</span>
                                    </div>
                                </div>
                                    ...
                                    @if($document->files->count())
                                        <ul class="space-y-2">
                                            @foreach($document->files as $file)
                                                <li class="flex items-center justify-between bg-white border rounded-lg px-4 py-2">
                                                    ...
                                                    <div class="flex items-center gap-3 text-sm">
                                                        <a
                                                            href="{{ route('documents.download', $file) }}"
