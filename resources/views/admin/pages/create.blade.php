<x-layout>
    <x-slot:title>إضافة صفحة جديدة</x-slot:title>
    ...
    <div style="max-width: 800px;">
        ...
        <x-card>
            <x-slot:header>
                <h2 style="font-size: 18px; font-weight: 600;">معلومات الصفحة</h2>
            </x-slot:header>
            ...
            <form method="POST" action="{{ route('admin.pages.store') }}">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="title" value="{{ old('title') }}" required
                           ...
                           placeholder="مثال: لوحة التحليلات">
                    @error('title')
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="url" name="iframe_url" value="{{ old('iframe_url') }}" required
                           style="width: 100%; padding: 10px 14px; border: 1px solid var(--border); border-radius: 6px; font-size: 14px;"
                           placeholder="https://arcgis.com">
                    @error('iframe_url')
                ...
                <div style="display: flex; gap: 12px; margin-top: 24px;">
                    <button type="submit" style="padding: 10px 24px; background: var(--primary); color: white; border: none; border-radius: 6px; font-size: 14px; font-weight: 500; cursor: pointer;">
                        حفظ
                    </button>
